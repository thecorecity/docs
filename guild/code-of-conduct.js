...
let embed = {
	...
	description: `**Общие нормы поведения для The Core Community**.\n`+
...
// c!dev eval
let embed = {
	description: `\`1.\` Чтите других так же, как и себя. Старайтесь быть доброжелательными и спокойными, а при возникновении конфликта - решить его мирным путём.\n`+
