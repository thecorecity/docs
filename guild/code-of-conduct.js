...
let embed = {
	description:
		...
		`\`4.\` Для NSFW контента в явном и неявном виде существует определённый для этого канал \<#524274148185341973>. Доступ только по письменной просьбе типа “Пожалуйста, выдайте доступ к каналу \<#524274148185341973>”.\n` +
